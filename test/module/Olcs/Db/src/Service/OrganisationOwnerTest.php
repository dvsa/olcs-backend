...
/**
 * Tests OrganisationOwner Service
 *
...
use Olcs\Db\Service\OrganisationOwner;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class OrganisationOwnerTest extends PHPUnit_Framework_TestCase
{
    /**
     * Setup the service
     */
    protected function setUp()
    {
        ...
        $this->service = new OrganisationOwner();
    }
