...
/**
 * Tests ConvictionCategory Controller
 *
...
use Olcs\Db\Controller\ConvictionCategoryController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class ConvictionCategoryControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new ConvictionCategoryController();
    }
