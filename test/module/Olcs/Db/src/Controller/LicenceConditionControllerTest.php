...
/**
 * Tests LicenceCondition Controller
 *
...
use Olcs\Db\Controller\LicenceConditionController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class LicenceConditionControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new LicenceConditionController();
    }
