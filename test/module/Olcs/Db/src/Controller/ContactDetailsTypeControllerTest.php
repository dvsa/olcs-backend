...
/**
 * Tests ContactDetailsType Controller
 *
...
use Olcs\Db\Controller\ContactDetailsTypeController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class ContactDetailsTypeControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new ContactDetailsTypeController();
    }
