...
use Olcs\Db\Controller\TrafficAreaController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class TrafficAreaControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new TrafficAreaController();
    }
