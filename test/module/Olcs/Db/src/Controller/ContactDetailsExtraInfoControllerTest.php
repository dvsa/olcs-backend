...
/**
 * Tests ContactDetailsExtraInfo Controller
 *
...
use Olcs\Db\Controller\ContactDetailsExtraInfoController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class ContactDetailsExtraInfoControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new ContactDetailsExtraInfoController();
    }
