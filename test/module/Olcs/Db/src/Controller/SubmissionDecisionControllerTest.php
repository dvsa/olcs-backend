...
/**
 * Tests SubmissionDecision Controller
 *
...
use Olcs\Db\Controller\SubmissionDecisionController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class SubmissionDecisionControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new SubmissionDecisionController();
    }
