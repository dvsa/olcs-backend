...
/**
 * Tests TmLicenseLink Controller
 *
...
use Olcs\Db\Controller\TmLicenseLinkController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class TmLicenseLinkControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new TmLicenseLinkController();
    }
