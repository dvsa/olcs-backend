...
/**
 * Tests CaseDetailComment Controller
 *
...
use Olcs\Db\Controller\CaseDetailCommentController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class CaseDetailCommentControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new CaseDetailCommentController();
    }
