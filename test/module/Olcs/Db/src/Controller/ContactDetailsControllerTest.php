...
/**
 * Tests ContactDetails Controller
 *
...
use Olcs\Db\Controller\ContactDetailsController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class ContactDetailsControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new ContactDetailsController();
    }
