...
/**
 * Tests TmQualification Controller
 *
...
use Olcs\Db\Controller\TmQualificationController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class TmQualificationControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new TmQualificationController();
    }
