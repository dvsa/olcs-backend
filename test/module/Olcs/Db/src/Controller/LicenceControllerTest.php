...
use Olcs\Db\Controller\LicenceController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class LicenceControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new LicenceController();
    }
