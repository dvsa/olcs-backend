...
class AcceptScoringTest extends CommandHandlerTestCase
{
    ...
    public function testStockAvailabilityCombinedRangeSizeNull()
    {
        $stockId = 35;
        ...
        $this->assertEquals(
            ['Prerequisite failed: no permits remaining within this stock.'],
            $result->getMessages()
        );
    }

    public function testStockAvailabilityCombinedRangeSizeInadequate()
    {
        $stockId = 47;
