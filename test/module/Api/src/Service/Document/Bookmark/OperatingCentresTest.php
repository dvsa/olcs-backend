 ...
 */
class OperatingCentresTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRenderWithGoodsLicence()
    {
        ...
        $bookmark = $this->getMock('Dvsa\Olcs\Api\Service\Document\Bookmark\OperatingCentres', ['getSnippet']);
