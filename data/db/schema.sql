...
CREATE TABLE IF NOT EXISTS `admin_area_traffic_area` (
  `admin_area` CHAR(40) NOT NULL COMMENT 'Admin area used to link local auth from address service to traffic area',
...
CREATE TABLE IF NOT EXISTS `address` (
  ...
  CONSTRAINT `fk_address_admin_area_traffic_area1`
    ...
    REFERENCES `admin_area_traffic_area` (`admin_area`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `application` (
  ...
  `receivership` TINYINT(1) NOT NULL DEFAULT 0,
  ...
  `prev_been_disqualified_eu` TINYINT(1) NULL,
...
CREATE TABLE IF NOT EXISTS `traffic_area_enforcement_area` (
  ...
  PRIMARY KEY (`traffic_area_id`, `enforcement_area_id`),
...
CREATE TABLE IF NOT EXISTS `postcode_enforcement_area` (
  ...
  PRIMARY KEY (`postcode_id`, `enforcement_area_id`),
...
CREATE TABLE IF NOT EXISTS `doc_paragraph_bookmark` (
  ...
  `last_modified_on` DATETIME NULL,
  `version` INT NOT NULL DEFAULT 1,
  PRIMARY KEY (`doc_bookmark_id`, `doc_paragraph_id`),
...
CREATE TABLE IF NOT EXISTS `doc_template_bookmark` (
  ...
  `last_modified_on` DATETIME NULL,
  `version` INT NOT NULL DEFAULT 1,
  PRIMARY KEY (`doc_template_id`, `doc_bookmark_id`),
...
CREATE TABLE IF NOT EXISTS `workshop` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `licence_id` INT NOT NULL,
  `is_external` TINYINT(1) NOT NULL COMMENT 'Is garage or workshop.',
  `maintenance` TINYINT(1) NOT NULL COMMENT 'Carries out maintenance.',
  `safety_inspection` TINYINT(1) NOT NULL COMMENT 'Carries out own safety inspections.',
...
CREATE TABLE IF NOT EXISTS `application_completion` (
  `application_id` INT NOT NULL,
  `section_yb_status` TINYINT NULL,
  `section_yb_bt_status` TINYINT NULL,
  `section_yb_bd_status` TINYINT NULL,
  `section_yb_add_status` TINYINT NULL,
  `section_yb_peo_status` TINYINT NULL,
  `section_tol_status` TINYINT NULL,
  `section_tol_ol_status` TINYINT NULL,
  `section_tol_ot_status` TINYINT NULL,
  `section_tol_lt_status` TINYINT NULL,
  `section_ocs_status` TINYINT NULL,
  `section_ocs_auth_status` TINYINT NULL,
  `section_ocs_fe_status` TINYINT NULL,
  `section_tms_status` TINYINT NULL,
  `section_veh_status` TINYINT NULL,
  `section_veh_v_status` TINYINT NULL,
  `section_veh_vpsv_status` TINYINT NULL,
  `section_veh_s_status` TINYINT NULL,
  `section_ph_status` TINYINT NULL,
  `section_ph_fh_status` TINYINT NULL,
  `section_ph_lh_status` TINYINT NULL,
  `section_ph_cp_status` TINYINT NULL,
  `section_rd_status` TINYINT NULL,
  `section_pay_status` TINYINT NULL,
  `section_sub_status` TINYINT NULL,
  `section_pay_pay_status` TINYINT NULL,
  `section_pay_summary_status` TINYINT NULL,
  `section_tp_status` TINYINT NULL,
  `section_tp_lic_status` TINYINT NULL,
...
CREATE TABLE IF NOT EXISTS `ref_data_value` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ref_data_values_ref_data_language1_idx` (`language_iso2` ASC),
  INDEX `fk_ref_data_values_ref_data1_idx` (`ref_data_id` ASC),
  CONSTRAINT `fk_ref_data_values_ref_data_language1`
    FOREIGN KEY (`language_iso2`)
    REFERENCES `language` (`iso2`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `pi` (
  ...
  `type_disciplinary` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Is disciplinary type',
...
CREATE TABLE IF NOT EXISTS `bus_reg_traffic_area` (
  ...
  `last_modified_on` DATETIME NULL,
  `version` INT NOT NULL DEFAULT 1,
  PRIMARY KEY (`traffic_area_id`, `bus_reg_id`),
...
CREATE TABLE IF NOT EXISTS `application_action` (
  ...
  PRIMARY KEY (`application_id`, `application_action_ref_id`),
