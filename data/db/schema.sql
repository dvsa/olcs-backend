...
CREATE TABLE `application` (
  ...
  `psv_medium_vhl_confirmation` TINYINT(1) NULL COMMENT 'User confirms compliance for restricted psv medium vehicle legislation. Section 8 of PSV 421 form',
  `psv_medium_vhl_notes` VARCHAR(1000) NULL COMMENT 'Notes by applicant on psv restriced medium vehicles.',
...
CREATE TABLE `other_licence` (
  ...
  CONSTRAINT `fk_other_licence_user2` FOREIGN KEY (`last_modified_by`)
    REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
