...
CREATE TABLE IF NOT EXISTS `organisation` (
  ...
  `is_mlh` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `company_cert_seen` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `irfo_nationality` VARCHAR(45) NULL,
  `is_irfo` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `allow_email` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  `is_member_state` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `address` (
  ...
  `paon_desc` VARCHAR(90) NULL COMMENT '{CONFIG}{"property":"addressLine2"}{/CONFIG}',
  `saon_start` VARCHAR(5) NULL,
  `saon_end` VARCHAR(5) NULL,
  `saon_desc` VARCHAR(90) COMMENT '{CONFIG}{"property":"addressLine1"}{/CONFIG}',
  `street` VARCHAR(100) NULL COMMENT '{CONFIG}{"property":"addressLine3"}{/CONFIG}',
  `locality` VARCHAR(35) NULL COMMENT '{CONFIG}{"property":"addressLine4"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `contact_details` (
  ...
  `licence_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Licence","property":"contactDetail"}}{/CONFIG}',
  `organisation_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Organisation","property":"contactDetail"}}{/CONFIG}',
  `address_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Address","property":"contactDetail"}}{/CONFIG}',
  `person_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Person","property":"contactDetail"}}{/CONFIG}',
  `forename` VARCHAR(40) NULL,
  `family_name` VARCHAR(40) NULL,
  `written_permission_to_engage` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `deleted_date` DATETIME NULL,
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `account_disabled` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `deleted_date` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `licence` (
  ...
  `organisation_id` INT NOT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Organisation","property":"licence"}}{/CONFIG}',
  ...
  `safety_ins` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Does own safety inspections. {CONFIG}{"type":"yesno"}{/CONFIG}',
  `safety_ins_varies` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'New olcs column for when some vehicles inspected more often {CONFIG}{"type":"yesno"}{/CONFIG}',
  `ni_flag` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  ...
  `translate_to_welsh` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `application` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `licence_id` INT NOT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Licence","property":"application"}}{/CONFIG}',
  `status` VARCHAR(32) NOT NULL,
  `has_entered_reg` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `tot_auth_trailers` INT NULL,
  `tot_auth_vehicles` INT NULL,
  `tot_auth_small_vehicles` INT NULL,
  `tot_auth_medium_vehicles` INT NULL,
  ...
  `tot_community_licences` INT NULL,
  `licence_type` VARCHAR(32) NOT NULL,
  `bankrupt` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `administration` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `disqualified` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `liquidation` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `receivership` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `insolvency_confirmation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `insolvency_details` VARCHAR(4000) NULL,
  `safety_confirmation` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  ...
  `prev_has_licence` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `prev_had_licence` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `prev_been_refused` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `prev_been_revoked` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `prev_been_at_pi` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `prev_been_disqualified_tc` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `prev_purchased_assets` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `override_ooo` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `prev_conviction` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `convictions_confirmation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `psv_operate_small_vhl` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `psv_small_vhl_notes` VARCHAR(4000) NULL,
  `psv_small_vhl_confirmation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `psv_no_small_vhl_confirmation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `psv_limosines` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `psv_no_limosine_confirmation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `psv_only_limosines_confirmation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `s4` (
  ...
  `surrender_licence` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_true_s4` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `licence_operating_centre` (
  ...
  `ad_placed` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `ad_placed_in` VARCHAR(70) NULL,
  `ad_placed_date` DATE NULL,
  `sufficient_parking` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `permission` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  ...
  `deleted_date` DATETIME NULL,
  `is_interim` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `publication_appropriate` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `application_operating_centre` (
  ...
  `ad_placed_in` VARCHAR(70) NULL,
  `ad_placed_date` DATE NULL,
  `publication_appropriate` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `permission` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `sufficient_parking` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `no_of_trailers_required` INT NULL,
  `no_of_vehicles_required` INT NULL,
  `no_of_vehicles_possessed` INT NULL,
  `no_of_trailers_possessed` INT NULL,
  ...
  `deleted_date` DATETIME NULL,
  `is_interim` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `document_sub_category` (
  ...
  `description` VARCHAR(255) NOT NULL,
  `is_scanned` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `display_free_text` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `opposition` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `is_representation` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `application_id` INT NOT NULL,
  `notes` VARCHAR(4000) NULL,
  `is_copied` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `raised_date` DATE NULL,
  `opposer_id` INT NOT NULL,
  `is_in_time` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_public_inquiry` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `deleted_date` DATETIME NULL,
  `is_valid` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `bus_reg` (
  ...
  `end_date` DATE NULL,
  `is_short_notice` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Application late.  Enables short notice detail entry {CONFIG}{"type":"yesno"}{/CONFIG}',
  `use_all_stops` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `has_manoeuvre` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Service reverses, turns around etc. {CONFIG}{"type":"yesno"}{/CONFIG}',
  `manoeuvre_detail` VARCHAR(255) NULL,
  `need_new_stop` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Needs a new bus stop {CONFIG}{"type":"yesno"}{/CONFIG}',
  `new_stop_detail` VARCHAR(255) NULL,
  `has_not_fixed_stop` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Stops at not predefined stop.  i.e. waved down by user {CONFIG}{"type":"yesno"}{/CONFIG}',
  ...
  `timetable_acceptable` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `map_supplied` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `route_description` VARCHAR(1000) NULL,
  `copied_to_la_pte` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `la_short_note` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `application_signed` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  ...
  `op_notified_la_pte` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `stopping_arrangements` VARCHAR(800) NULL,
  `trc_condition_checked` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  ...
  `is_txc_app` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Was created through transxchange {CONFIG}{"type":"yesno"}{/CONFIG}',
  ...
  `withdrawn_reason` VARCHAR(32) NULL,
  `short_notice_refused` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `document` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `document_store_id` VARCHAR(255) NOT NULL COMMENT '{CONFIG}{"property":"identifier"}{/CONFIG}',
  `description` VARCHAR(255) NULL,
  `traffic_area_id` VARCHAR(1) NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"TrafficArea","property":"document"}}{/CONFIG}',
  `category_id` INT NOT NULL,
  `document_sub_category_id` INT NULL,
  `is_read_only` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `licence_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Licence","property":"document"}}{/CONFIG}',
  `application_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Application","property":"document"}}{/CONFIG}',
  `case_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Cases","property":"document"}}{/CONFIG}',
  `transport_manager_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"TransportManager","property":"document"}}{/CONFIG}',
  `operating_centre_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"OperatingCentre","property":"adDocument"}}{/CONFIG}',
  `opposition_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Opposition","property":"document"}}{/CONFIG}',
  `bus_reg_id` INT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"BusReg","property":"document"}}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `doc_template` (
  ...
  `is_ni` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `suppress_from_op` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `category_id` INT NOT NULL,
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `email` (
  ...
  `is_sensitive` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `vehicle` (
  ...
  `is_articulated` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `certificate_no` VARCHAR(50) NULL,
  `is_refrigerated` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `is_tipper` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `is_novelty` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `vi_action` VARCHAR(1) NULL,
  `section26` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `section26_curtail` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `section26_revoked` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `section26_suspend` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `deleted_date` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `licence_vehicle` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `licence_id` INT NOT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Licence","property":"licenceVehicle"}}{/CONFIG}',
  `vehicle_id` INT NOT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Vehicle","property":"licenceVehicle"}}{/CONFIG}',
  `application_id` INT NULL,
  `application_received_date` DATE NULL,
  `deleted_date` DATETIME NULL,
  `removal_reason` VARCHAR(32) NULL,
  `removal` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `goods_disc` (
  ...
  `is_copy` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_interim` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `requested_by_self_service_user` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `reprint_required` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `removal_reason` VARCHAR(32) NULL,
...
CREATE TABLE IF NOT EXISTS `psv_disc` (
  ...
  `issued_date` DATETIME NULL,
  `ceased_date` DATETIME NULL,
  `is_copy` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `reprint_required` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `trading_name` (
  ...
  `licence_id` INT NULL,
  `organisation_id` INT NULL COMMENT 'Used by IRFO {CONFIG}{"inversedBy":{"entity":"Organisation","property":"tradingName"}}{/CONFIG}',
  `deleted_date` DATETIME NULL,
  `vi_action` VARCHAR(1) NULL,
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
...
CREATE TABLE IF NOT EXISTS `workshop` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `licence_id` INT NOT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"Licence","property":"workshop"}}{/CONFIG}',
  `is_external` TINYINT(1) NOT NULL COMMENT 'Is garage or workshop. {CONFIG}{"type":"yesno"}{/CONFIG}',
  `maintenance` TINYINT(1) NOT NULL COMMENT 'Carries out maintenance. {CONFIG}{"type":"yesno"}{/CONFIG}',
  `safety_inspection` TINYINT(1) NOT NULL COMMENT 'Carries out own safety inspections. {CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `stay` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `case_id` INT NOT NULL,
  `is_tc` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `conviction` (
  ...
  `msi` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `is_declared` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `irfo_gv_permit` (
  ...
  `is_fee_exempt` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `in_force_date` DATE NULL,
  `irfo_fee_id` VARCHAR(10) NULL,
  `no_of_copies` INT NOT NULL DEFAULT 0,
  `note` VARCHAR(2000) NULL,
  `permit_printed` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `irfo_psv_auth` (
  ...
  `exemption_details` VARCHAR(255) NULL,
  `expiry_date` DATE NULL,
  `is_fee_exempt_application` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_fee_exempt_annual` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `in_force_date` DATE NULL,
...
CREATE TABLE IF NOT EXISTS `note` (
  ...
  `priority` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `application_completion` (
  `id` INT NOT NULL,
  `section_yb_status` INT NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessStatus"}{/CONFIG}',
  `section_yb_bt_status` INT NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessBusinessTypeStatus"}{/CONFIG}',
  `section_yb_bd_status` INT NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessBusinessDetailsStatus"}{/CONFIG}',
  `section_yb_add_status` INT NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessAddressesStatus"}{/CONFIG}',
  `section_yb_peo_status` INT NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessPeopleStatus"}{/CONFIG}',
  `section_tol_status` INT NULL COMMENT '{CONFIG}{"property":"sectionTypeOfLicenceStatus"}{/CONFIG}',
  `section_tol_ol_status` INT NULL COMMENT '{CONFIG}{"property":"sectionTypeOfLicenceOperatorLocationStatus"}{/CONFIG}',
  `section_tol_ot_status` INT NULL COMMENT '{CONFIG}{"property":"sectionTypeOfLicenceOperatorTypeStatus"}{/CONFIG}',
  `section_tol_lt_status` INT NULL COMMENT '{CONFIG}{"property":"sectionTypeOfLicenceLicenceTypeStatus"}{/CONFIG}',
  `section_ocs_status` INT NULL COMMENT '{CONFIG}{"property":"sectionOperatingCentresStatus"}{/CONFIG}',
  `section_ocs_auth_status` INT NULL COMMENT '{CONFIG}{"property":"sectionOperatingCentresAuthorisationStatus"}{/CONFIG}',
  `section_ocs_fe_status` INT NULL COMMENT '{CONFIG}{"property":"sectionOperatingCentresFinancialEvidenceStatus"}{/CONFIG}',
  `section_tms_status` INT NULL COMMENT '{CONFIG}{"property":"sectionTransportManagersStatus"}{/CONFIG}',
  `section_veh_status` INT NULL COMMENT '{CONFIG}{"property":"sectionVehicleSafetyStatus"}{/CONFIG}',
  `section_veh_v_status` INT NULL COMMENT '{CONFIG}{"property":"sectionVehicleSafetyVehicleStatus"}{/CONFIG}',
  `section_veh_vpsv_status` INT NULL COMMENT '{CONFIG}{"property":"sectionVehicleSafetyVehiclePsvStatus"}{/CONFIG}',
  `section_veh_s_status` INT NULL COMMENT '{CONFIG}{"property":"sectionVehicleSafetySafetyStatus"}{/CONFIG}',
  `section_ph_status` INT NULL COMMENT '{CONFIG}{"property":"sectionPreviousHistoryStatus"}{/CONFIG}',
  `section_ph_fh_status` INT NULL COMMENT '{CONFIG}{"property":"sectionPreviousHistoryFinancialHistoryStatus"}{/CONFIG}',
  `section_ph_lh_status` INT NULL COMMENT '{CONFIG}{"property":"sectionPreviousHistoryLicenceHistoryStatus"}{/CONFIG}',
  `section_ph_cp_status` INT NULL COMMENT '{CONFIG}{"property":"sectionPreviousHistoryConvictionsPenaltiesStatus"}{/CONFIG}',
  `section_rd_status` INT NULL COMMENT '{CONFIG}{"property":"sectionReviewDeclarationsStatus"}{/CONFIG}',
  `section_pay_status` INT NULL COMMENT '{CONFIG}{"property":"sectionPaymentSubmissionStatus"}{/CONFIG}',
  `section_pay_pay_status` INT NULL COMMENT '{CONFIG}{"property":"sectionPaymentSubmissionPaymentStatus"}{/CONFIG}',
  `section_pay_summary_status` INT NULL COMMENT '{CONFIG}{"property":"sectionPaymentSubmissionSummaryStatus"}{/CONFIG}',
  `section_tp_status` INT NULL COMMENT '{CONFIG}{"property":"sectionTaxiPhvStatus"}{/CONFIG}',
  `section_tp_lic_status` INT NULL COMMENT '{CONFIG}{"property":"sectionTaxiPhvLicenceStatus"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `presiding_tc` (
  `id` INT NOT NULL,
  `name` VARCHAR(70) NOT NULL,
  `deleted` TINYINT(1) NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `condition_undertaking` (
  ...
  `deleted_date` DATETIME NULL,
  `is_draft` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `case_id` INT NULL,
  `is_fulfilled` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `licence_id` INT NULL,
  `notes` VARCHAR(8000) NULL,
  `operating_centre_id` INT NULL,
  `application_id` INT NULL,
  `lic_condition_variation_id` INT NULL,
  `is_approved` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `previous_licence` (
  ...
  `will_surrender` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `organisation_user` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `organisation_id` INT NOT NULL,
  `user_id` INT NOT NULL COMMENT '{CONFIG}{"inversedBy":{"entity":"User","property":"organisationUser"}}{/CONFIG}',
  `is_administrator` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `added_date` DATETIME NULL,
  `removed_date` DATETIME NULL,
  `sftp_access` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `reason` (
  ...
  `is_decision` TINYINT(1) NOT NULL COMMENT 'true if reason.  false if decision {CONFIG}{"type":"yesno"}{/CONFIG}',
  `section_code` VARCHAR(50) NOT NULL,
  `description` VARCHAR(255) NOT NULL,
  `is_read_only` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_ni` TINYINT(1) NOT NULL COMMENT 'Northern Ireland or not {CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_propose_to_revoke` TINYINT(1) NOT NULL COMMENT 'Used in Propose to Revoke {CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `pi` (
  ...
  `type_app_new` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `type_app_var` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `type_disciplinary` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Is disciplinary type {CONFIG}{"type":"yesno"}{/CONFIG}',
  `type_env_new` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `type_env_var` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `type_oc_review` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `type_impounding` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `type_other` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `pi_datetime` DATETIME NULL,
  `venue` VARCHAR(255) NULL,
  `witnesses` INT NULL,
  `presiding_tc_id` INT NULL,
  `presiding_tc_other` VARCHAR(45) NULL COMMENT 'Free text if presiding tc not in reference data',
  `is_cancelled` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `presided_by` VARCHAR(32) NULL,
  `pi_status` VARCHAR(32) NOT NULL,
  `is_adjourned` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  ...
  `decision_date` DATE NULL,
  `licence_revoked_at_pi` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `legacy_case_action` (
  `id` INT NOT NULL,
  `description` VARCHAR(45) NULL,
  `is_driver` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `legacy_recommendation` (
  ...
  `revoke_lic` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `status` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `pi_definition` (
  ...
  `is_ni` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `task` (
  ...
  `is_closed` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `urgent` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `licence_id` INT NULL,
  `application_id` INT NULL,
  `bus_reg_id` INT NULL,
...
CREATE TABLE IF NOT EXISTS `inspection_email` (
  ...
  `processed` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `bus_reg_traffic_area` (
  ...
  `traffic_area_id` VARCHAR(1) NOT NULL,
  `bus_reg_id` INT NOT NULL,
  `txc_missing` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `txc_not_required` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `bus_short_notice` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `bus_reg_id` INT NOT NULL,
  `bank_holiday_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `unforseen_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `unforseen_detail` VARCHAR(255) NULL,
  `timetable_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `timetable_detail` VARCHAR(255) NULL,
  `replacement_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `replacement_detail` VARCHAR(255) NULL,
  `holiday_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `holiday_detail` VARCHAR(255) NULL,
  `trc_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `trc_detail` VARCHAR(255) NULL,
  `police_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `police_detail` VARCHAR(255) NULL,
  `special_occasion_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `special_occasion_detail` VARCHAR(255) NULL,
  `connection_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `connection_detail` VARCHAR(255) NULL,
  `not_available_change` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `recipient` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `send_app_decision` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `send_notices_procs` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_police` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_objector` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `deleted_date` DATETIME NULL,
  `contact_details_id` INT NOT NULL,
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
...
CREATE TABLE IF NOT EXISTS `fee_type` (
  ...
  `expire_fee_with_licence` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Dont allow payment after licence expires {CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `fee` (
  ...
  `irfo_fee_id` VARCHAR(10) NULL,
  `irfo_fee_exempt` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `ebsr_submission_result` (
  ...
  `email_authority` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `description` VARCHAR(100) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ebsr_submission` (
  ...
  `is_from_ftp` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `organisation_id` INT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `alpha_split` (
  ...
  `is_deleted` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `application_action_ref` (
  ...
  `default_received` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `default_approved` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `application_action` (
  ...
  `is_received` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `is_approved` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `is_applicable` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `serious_infringement` (
  ...
  `erru_response_sent` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `si_penalty` (
  ...
  `imposed` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `start_date` DATE NULL,
  `end_date` DATE NULL,
...
CREATE TABLE IF NOT EXISTS `correspondence_inbox` (
  `id` INT NOT NULL,
  `archived` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `accessed` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `email_reminder_sent` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `printed` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `document_id` INT NOT NULL,
  `licence_id` INT NOT NULL,
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
...
CREATE TABLE IF NOT EXISTS `disc_sequence` (
  ...
  `traffic_area_id` CHAR(1) NULL,
  `is_self_serve` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `is_ni_self_serve` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `disqualification` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `is_disqualified` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `start_date` DATE NULL,
...
CREATE TABLE IF NOT EXISTS `community_lic_suspension` (
  ...
  `is_actioned` TINYINT(1) NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `irfo_vehicle` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `coc_a` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `coc_b` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `coc_c` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `coc_d` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `coc_t` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `vrm` VARCHAR(20) NOT NULL,
  `irfo_psv_auth_id` INT NULL,
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
...
CREATE TABLE IF NOT EXISTS `system_info_message` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `is_internal` TINYINT(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `opposition_grounds` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `opposition_id` INT NOT NULL,
  `is_representation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `tm_case_decision` (
  ...
  `is_msi` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `tm_grace_period` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `licence_id` INT NOT NULL,
  `is_active` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `txc_inbox` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `file_read` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `bus_reg_id` INT NOT NULL,
  `local_authority_id` INT NULL,
  `organisation_id` INT NULL,
...
CREATE TABLE IF NOT EXISTS `public_holiday` (
  ...
  `is_england` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `is_wales` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `is_scotland` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `is_ni` TINYINT(1) NULL COMMENT '{CONFIG}{"type":"yesnonull"}{/CONFIG}',
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `pi_hearing` (
  ...
  `is_adjourned` tinyint(1) NOT NULL COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
