...
CREATE TABLE IF NOT EXISTS `traffic_area` (
  ...
  `scottish_rules` TINYINT(1) NOT NULL DEFAULT 0,
  `created_by` INT NULL,
  `last_modified_by` INT NULL,
  `created_on` DATETIME NULL,
  `last_modified_on` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `application` (
  ...
  `tot_community_licences` INT NULL,
  `licence_type` VARCHAR(32) NULL,
  `bankrupt` TINYINT(1) NULL DEFAULT 0,
  `administration` TINYINT(1) NULL DEFAULT 0,
  `disqualified` TINYINT(1) NULL DEFAULT 0,
  `liquidation` TINYINT(1) NULL DEFAULT 0,
  `receivership` TINYINT(1) NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `pi_reason` (
  ...
  `version` INT NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
  INDEX `fk_case_rec_pi_reason_pi_reason1_idx` (`reason_id` ASC),
  INDEX `fk_case_pi_reason_pi_detail1_idx` (`pi_id` ASC),
  INDEX `fk_case_pi_reason_user1_idx` (`created_by` ASC),
  INDEX `fk_case_pi_reason_user2_idx` (`last_modified_by` ASC),
  UNIQUE INDEX `pi_reason_unique` (`pi_id` ASC, `reason_id` ASC),
...
CREATE TABLE IF NOT EXISTS `pi_hearing` (
  ...
  INDEX `fk_pi_hearing_ref_data1_idx` (`presided_by` ASC),
...
CREATE TABLE IF NOT EXISTS `legacy_recommendation_pi_reason` (
  ...
  INDEX `fk_legacy_recommendation_pi_reason_pi_reason1_idx` (`reason_id` ASC),
