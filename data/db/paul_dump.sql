...
CREATE TABLE `bus_reg_traffic_area` (
  ...
  KEY `ix_bus_reg_traffic_area_created_by` (`created_by`),
  KEY `ix_bus_reg_traffic_area_last_modified_by` (`last_modified_by`),
  ...
  CONSTRAINT `fk_bus_reg_traffic_area_created_by_user_id` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_bus_reg_traffic_area_last_modified_by_user_id` FOREIGN KEY (`last_modified_by`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
