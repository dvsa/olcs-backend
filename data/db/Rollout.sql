...
INSERT INTO `ref_data` (`display_order`, `ref_data_category_id`, `id`, `description`, `olbs_key`) VALUES
    ...
    (2, 'submission_section', 'submission_section_pers', 'Persons', NULL),
    (3, 'submission_section', 'submission_section_ochi', 'Operating centre history', NULL),
    (4, 'submission_section', 'submission_section_inuc', 'Intelligence unit check', NULL),
    (5, 'submission_section', 'submission_section_advt', 'Advertisement', NULL),
    (6, 'submission_section', 'submission_section_alau', 'All auths', NULL),
    (7, 'submission_section', 'submission_section_cusu', 'Current submissions', NULL),
    (8, 'submission_section', 'submission_section_trma', 'Transport managers', NULL),
    (9, 'submission_section', 'submission_section_fire', 'Fitness & repute', NULL),
    (10, 'submission_section', 'submission_section_brad', 'Bus registration application details', NULL),
    (11, 'submission_section', 'submission_section_tbus', 'Total bus registrations', NULL),
    (12, 'submission_section', 'submission_section_mlhh', 'Linked MLH history', NULL),
    (13, 'submission_section', 'submission_section_mtdh', 'Maintenance / Tachographs / Drivers hours', NULL),
    (14, 'submission_section', 'submission_section_cpoh', 'Conviction / FPN / Offence history', NULL),
    (15, 'submission_section', 'submission_section_pens', 'Penalties', NULL),
    (16, 'submission_section', 'submission_section_terp', 'TE reports', NULL),
    (17, 'submission_section', 'submission_section_plpm', 'Planning permission', NULL),
    (18, 'submission_section', 'submission_section_vaes', 'Visibility / access egress size', NULL),
    (19, 'submission_section', 'submission_section_envc', 'Environmental complaints', NULL),
    (20, 'submission_section', 'submission_section_objs', 'Objections', NULL),
    (21, 'submission_section', 'submission_section_fnin', 'Financial information', NULL),
    (22, 'submission_section', 'submission_section_wflf', 'Waive fee / Late fee', NULL),
    (23, 'submission_section', 'submission_section_annx', 'Annex', NULL),
    (24, 'submission_section', 'submission_section_msin', 'Most serious incident', NULL),
    (25, 'submission_section', 'submission_section_opce', 'Operating centres', NULL),
    (26, 'submission_section', 'submission_section_ctud', 'Conditions and undertakings', NULL),
    (27, 'submission_section', 'submission_section_intm', 'Interim', NULL),
    (28, 'submission_section', 'submission_section_llan', 'Linked licences & application numbers', NULL),
    (29, 'submission_section', 'submission_section_ltca', 'Lead TC area', NULL),
    (30, 'submission_section', 'submission_section_auth', 'Authorisation requested applied for', NULL),
    (31, 'submission_section', 'submission_section_cnec', 'Continuous and effective control', NULL),
    (32, 'submission_section', 'submission_section_preh', 'Previous history', NULL),
    (33, 'submission_section', 'submission_section_trac', 'Transport authority comments', NULL),
    (34, 'submission_section', 'submission_section_llhi', 'Local licence history', NULL),
    (35, 'submission_section', 'submission_section_regd', 'Registration details', NULL),
    (36, 'submission_section', 'submission_section_proh', 'Prohibition history', NULL),
    (37, 'submission_section', 'submission_section_anth', 'Annual test history', NULL),
    (38, 'submission_section', 'submission_section_misc', 'Other issues / misc', NULL),
    (39, 'submission_section', 'submission_section_site', 'Site plans', NULL),
    (40, 'submission_section', 'submission_section_acom', 'Applicants comments', NULL),
    (41, 'submission_section', 'submission_section_comp', 'Case complaints', NULL),
