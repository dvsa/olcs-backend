...
INSERT INTO `address` (`id`, `created_by`, `last_modified_by`, `saon_desc`, `paon_desc`, `street`, `locality`, `postcode`, `county`, `city`, `country`, `created_on`, `last_modified_on`, `version`) VALUES
...
INSERT INTO `submission_section` (`id`, `created_by`, `last_modified_by`, `description`, `group`, `created_on`, `last_modified_on`, `version`) VALUES
...
INSERT INTO `category` (`id`, `created_by`, `last_modified_by`, `description`, `created_on`, `last_modified_on`, `version`) VALUES
(1,NULL,NULL,'Licensing',NULL,NULL,1);

INSERT INTO `document_sub_category` (`id`, `category_id`, `created_by`, `last_modified_by`, `description`, `isScanned`, `created_on`, `last_modified_on`, `version`) VALUES
...
INSERT INTO `organisation_person` (`id`, `created_by`, `last_modified_by`, `created_on`, `last_modified_on`, `version`, `person_id`, `organisation_id`) VALUES
...
INSERT INTO `disqualification` (`id`, `created_by`, `last_modified_by`, `is_disqualified`, `period`, `notes`, `created_on`, `last_modified_on`, `version`, `person_id`) VALUES
...
INSERT INTO `reason` (`id`, `created_by`, `last_modified_by`, `goods_or_psv`, `is_decision`, `section_code`, `is_read_only`, `is_ni`, `propose_to_revoke`, `created_on`, `last_modified_on`, `version`, `description`) VALUES
...
INSERT INTO `pi_reason` (`pi_id`, `pi_reason_id`) VALUES
    (1,118),
    (1,227);
...
INSERT INTO `transport_manager_licence` (`id`, `licence_id`, `transport_manager_id`, `created_by`, `last_modified_by`, `removedDate`, `created_on`, `last_modified_on`, `version`) VALUES
    ...
    INSERT INTO `transport_manager_licence` (`id`, `person_id`, `licence_id`, `created_by`, `last_modified_by`, `internal_external`, `created_on`, `last_modified_on`, `version`) VALUES
...
INSERT INTO `tm_qualification` (`id`, `transport_manager_id`, `created_by`, `last_modified_by`, `country_code`, `qualification_type`, `created_on`, `last_modified_on`, `version`) VALUES
    (1,1,NULL,NULL,'UK','CPCSI',NULL,NULL,1),
    (2,2,NULL,NULL,'UK','CPCSN',NULL,NULL,1);

    INSERT INTO `tm_qualification` (`id`, `person_id`, `created_by`, `last_modified_by`, `qualification_type`, `qualification_date`, `created_on`, `last_modified_on`, `version`) VALUES
...
INSERT INTO `cases` (`id`, `licence`, `created_by`, `last_modified_by`, `caseNumber`, `status`, `description`, `convictionData`, `ecms`, `openTime`, `owner`, `caseType`, `closedTime`, `annualTestHistory`, `created_on`, `last_modified_on`, `version`) VALUES
