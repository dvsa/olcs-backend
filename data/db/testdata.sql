...
INSERT INTO `admin_area_traffic_area`(id, traffic_area_id) VALUES ('NEWCASTLE UPON TYNE','B'),('GATESHEAD','B'),('NORTH TYNESIDE','B'),('SOUTH TYNESIDE','B'),('SUNDERLAND','B'),('BLACKBURN WITH DARWEN','C'),('BLACKPOOL','C'),('BOLTON','C'),('BURY','C'),('LANCASHIRE','C'),('CHESHIRE EAST','C'),('CHESHIRE WEST AND CHESTER','C'),('CALDERDALE','B'),('HALTON','C'),('KNOWSLEY','C'),('LIVERPOOL','C'),('MANCHESTER','C'),('STAFFORDSHIRE','D'),('OLDHAM','C'),('ROCHDALE','C'),('SALFORD','C'),('SEFTON COUNCIL','C'),('ST HELENS COUNCIL','C'),('STOCKPORT','B'),('TAMESIDE','C'),('TRAFFORD','C'),('WIGAN','C'),('WARRINGTON','C'),('WIRRAL','C'),('NOTTINGHAMSHIRE','B'),('DERBYSHIRE','C'),('LINCOLNSHIRE','B'),('LEICESTERSHIRE','F'),('NORTHAMPTONSHIRE','F'),('CITY OF STOKE-ON-TRENT','D'),('DERBY','C'),('DUDLEY','D'),('CAMBRIDGESHIRE','F'),('LEICESTER CITY','F'),('NOTTINGHAM CITY','B'),('WARWICKSHIRE','D'),('PETERBOROUGH','F'),('RUTLAND','F'),('WALSALL','D'),('WOLVERHAMPTON','D'),('WORCESTERSHIRE','D'),('BIRMINGHAM','D'),('COVENTRY','D'),('SHROPSHIRE','D'),('GLOUCESTERSHIRE','H'),('WEST MIDLANDS','D'),('SANDWELL','D'),('SOLIHULL','D'),('TELFORD AND WREKIN','D'),('BRACKNELL FOREST','H'),('BUCKINGHAMSHIRE','F'),('HAMPSHIRE','H'),('HERTFORDSHIRE','F'),('CENTRAL BEDFORDSHIRE','F'),('LUTON','F'),('HARROW','K'),('ESSEX','F'),('MILTON KEYNES','F'),('WEST BERKSHIRE','H'),('BEDFORD','F'),('READING','H'),('SLOUGH','H'),('OXFORDSHIRE','H'),('WINDSOR AND MAIDENHEAD','H'),('SURREY','K'),('WOKINGHAM','H'),('SUFFOLK','F'),('TOWN',NULL),('NORFOLK','F'),('SOUTHEND-ON-SEA','F'),('THURROCK','F'),('WEST SUSSEX','K'),('KENT','K'),('BRIGHTON & HOVE','K'),('EAST SUSSEX','K'),('CROYDON','K'),('LONDON BOROUGH OF HOUNSLOW','K'),('SUTTON','K'),('PORTSMOUTH CITY COUNCIL','H'),('MEDWAY','K'),('WILTSHIRE','H'),('SOUTHAMPTON','H'),('ISLE OF WIGHT','H'),('CITY OF LONDON','K'),('CITY OF WESTMINSTER','K'),('BARKING AND DAGENHAM','F'),('BEXLEY','K'),('BARNET','F'),('BRENT','K'),('CAMDEN','K'),('EALING','K'),('ENFIELD','K'),('LONDON BOROUGH OF BROMLEY','K'),('GREENWICH','K'),('ISLINGTON','K'),('KENSINGTON AND CHELSEA','K'),('HILLINGDON','K'),('HAVERING','K'),('HAMMERSMITH AND FULHAM','K'),('LONDON BOROUGH OF HARINGEY','K'),('KINGSTON UPON THAMES','K'),('HACKNEY','K'),('LAMBETH','K'),('RICHMOND UPON THAMES','K'),('NEWHAM','K'),('TOWER HAMLETS','K'),('LEWISHAM','K'),('REDBRIDGE','K'),('CARMARTHENSHIRE','G'),('FLINTSHIRE','G'),('CONWY','G'),('CEREDIGION','G'),('GWYNEDD','G'),('DENBIGHSHIRE','G'),('SOUTHWARK','K'),('CARDIFF','G'),('POWYS','G'),('WALTHAM FOREST','K'),('BLAENAU GWENT','G'),('MERTON','K'),('MONMOUTHSHIRE','G'),('ISLE OF ANGLESEY','G'),('NEWPORT','D'),('GREATER LONDON','K'),('MERTHYR TYDFIL UA','G'),('TORFAEN','G'),('SWANSEA','G'),('WREXHAM','G'),('PEMBROKESHIRE','G'),('VALE OF GLAMORGAN','G'),('RHONDDA CYNON TAFF','G'),('CAERPHILLY COUNTY BOROUGH','G'),('BRIDGEND COUNTY BOROUGH','G'),('NEATH PORT TALBOT','G'),('BARNSLEY','B'),('BRADFORD MDC','B'),('WEST YORKSHIRE','B'),('DONCASTER','B'),('NORTH YORKSHIRE','B'),('YORK','B'),('KIRKLEES','B'),('KINGSTON UPON HULL','B'),('LEEDS','B'),('ROTHERHAM','B'),('SHEFFIELD','B'),('WAKEFIELD','B'),('STOCKTON-ON-TEES','B'),('NORTH EAST LINCOLNSHIRE','B'),('NORTH LINCOLNSHIRE','B'),('EAST RIDING OF YORKSHIRE','B'),('CUMBRIA','C'),('NORTHUMBERLAND','B'),('DURHAM','B'),('DARLINGTON','B'),('MIDDLESBROUGH','B'),('HARTLEPOOL','B'),('BOURNEMOUTH','H'),('REDCAR AND CLEVELAND','B'),('DORSET','H'),('CORNWALL','H'),('DEVON','H'),('SOMERSET','H'),('PLYMOUTH','H'),('POOLE','H'),('TORBAY','H'),('BRISTOL','H'),('HEREFORDSHIRE','D'),('SWINDON','H'),('NORTH SOMERSET','H'),('BATH AND NORTH EAST SOMERSET','H'),('SOUTH GLOUCESTERSHIRE','H'),('ISLES OF SCILLY','H'),('NORTH LANARKSHIRE','M'),('GLASGOW CITY','M'),('South Lanarkshire','M'),('HIGHLAND','M'),('FALKIRK','M'),('DUMFRIES AND GALLOWAY','M'),('Perth And Kinross','M'),('West Lothian','M'),('STIRLING','M'),('DUNDEE CITY','M'),('FIFE','M'),('SOUTH AYRSHIRE','M'),('MORAY','M'),('SCOTTISH BORDERS','M'),('MIDLOTHIAN','M'),('AYRSHIRE','M'),('EAST LOTHIAN','M'),('ISLE OF ARRAN','M'),('EAST DUNBARTONSHIRE','M'),('WEST DUNBARTONSHIRE','M'),('CITY OF EDINBURGH','M'),('SHETLAND','M'),('Aberdeenshire','M'),('ORKNEY ISLANDS','M'),('NA H-EILEANAN AN IAR','M'),('ARGYLL AND BUTE','M'),('ANGUS','M'),('ABERDEEN CITY','M'),('EAST AYRSHIRE','M'),('EAST RENFREWSHIRE','M'),('CLACKMANNANSHIRE','M'),('Renfrewshire','M'),('Inverclyde','M'),('ISLE OF CUMBRAE','M'),('ORKNEY','M'),('HIGHLANDS','M'),('GLASGOW','M'),('ABERDEEN CUTY','M'),('EASTDUNBARTONSHIRE','M'),('EAS DUNBARTONSHIRE','M'),('GLASGOW CITY COUCIL','M'),('HIGHANDS','M'),('NORTH AYRSHIRE','M'),('AYR','M'),('SOUTH AYSHIRE','M'),('EAST DUNNBARTONSHIRE','M'),('LONDON BOROUGH OF HAVERING','K'),('EASE DUNBARTONSHIRE','M'),('ABERDEEN C ITY','M');
...
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (4,7,'Test document 4','testdocument4.doc',0,2,1,'DOC','2014-08-24 16:23:00');
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (5,7,'Test document 5','testdocument5.xls',0,3,1,'XLS','2014-07-01 15:01:00');
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (6,7,'Test document 6','testdocument6.docx',0,3,1,'DOCX','2014-07-05 09:00:05');
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (7,7,'Test document 7','testdocument7.xls',0,3,1,'XLS','2014-07-05 10:23:00');
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (8,7,'Test document 8','testdocument8.doc',1,3,2,'DOC','2014-07-05 10:45:00');
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (9,7,'Test document 9','testdocument9.ppt',1,5,1,'PPT','2014-08-05 08:59:40');
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (10,7,'Test document 10','testdocument10.jpg',0,4,1,'JPG','2014-08-08 12:47:00');
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (11,7,'Test document 11','testdocument11.txt',0,3,1,'TXT','2014-08-14 14:00:00');
INSERT INTO document(id,licence_id,description,filename,is_digital,category_id,document_sub_category_id,file_extension,issued_date) VALUES
    (12,7,'Test document 12','testdocument12.xls',1,4,1,'XLS','2014-08-28 14:03:00');
