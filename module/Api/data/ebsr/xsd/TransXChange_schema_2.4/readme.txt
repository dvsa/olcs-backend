Release 2.4 TransXChange  
(c) 2010 CROWN COPYRIGHT

2013-09-13 Update Patsh frofordocumentation from ..schemas/ to ... schema/ doc only

2.4 is an upgrade to TransXChange that supercedes 2.2a 

    It shares common NaPT data types with the NaPTAN & NPTG 2.4a release.
...
NB: 2.4 is a final stable release    
...
Changes 
2010-12-30 V2.4
         - Update Naptan Version no to 2.4
2010-08-09 V2.4b
         PTIC-001 Move EBSR agent to registration from operator  :  txc_operator : linear
         PTIC-013 Add marketign name & Line description by direction to Line : txc_service, txc_service_journeyGrouping : grouping+
