 ...
 */
final class CancelS4 extends AbstractCommandHandler
{
    ...
    public function handleCommand(CommandInterface $command)
    {
        ...
        $s4->setOutcome($this->getRepo()->getRefdataReference(S4::STATUS_CANCELLED));
        ...
        $this->result->addMessage('S4 Cancelled.');
