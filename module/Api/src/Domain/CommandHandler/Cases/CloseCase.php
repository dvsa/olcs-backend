...
use Dvsa\Olcs\Transfer\Command\Cases\CloseCase as CloseCaseCmd;
use Dvsa\Olcs\Api\Domain\CommandHandler\TransactionedInterface;

/**
 * Close a Case
 */
final class CloseCase extends AbstractCommandHandler implements TransactionedInterface
{
