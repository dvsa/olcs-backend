...
class FeeType extends AbstractFeeType
{
    ...
    const FEE_TYPE_IRHP_APP_BILATERAL_SINGLE_PRODUCT_REF = 'IRHP_GV_APP_BILATERAL_SINGLE';
    ...
    const FEE_TYPE_IRHP_ISSUE_BILATERAL_MULTI_MOROCCO_PRODUCT_REF = 'IRFO_GV_MOROCC_15J_PERMIT_FEE';
