...
/**
 * EcmtSiftingSettings Abstract Entity
 *
 * Auto-Generated
 *
 ...
 * )
 */
abstract class AbstractEcmtSiftingSettings implements BundleSerializableInterface, JsonSerializable
{
     ...
     * @var int
     *
     * @ORM\Column(type="integer", name="total_quota_permits", nullable=true)
     */
    protected $totalQuotaPermits;
    ...
    /**
     * Set the total quota permits
     *
     * @param int $totalQuotaPermits new value being set
     *
     * @return EcmtSiftingSettings
     */
    public function setTotalQuotaPermits($totalQuotaPermits)
    {
    ...
    /**
     * Get the total quota permits
     *
     * @return int
     */
    public function getTotalQuotaPermits()
    {
        return $this->totalQuotaPermits;
    }
