 ...
 * )
 */
abstract class AbstractSubmissionSectionComment
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Dvsa\Olcs\Api\Entity\Submission\Submission", inversedBy="submissionSectionComments")
