...
class Document extends AbstractDocument implements OrganisationProviderInterface
{
    ...
    const IRHP_PERMIT_ANN_BILAT_BELARUS = 'IRHP_PERMIT_ANN_BILAT_BELARUS';
    ...
    const IRHP_PERMIT_ANN_BILAT_GEORGIA = 'IRHP_PERMIT_ANN_BILAT_GEORGIA';
    ...
    const IRHP_PERMIT_ANN_BILAT_KAZAKHSTAN = 'IRHP_PERMIT_ANN_BILAT_KAZAKHSTAN';
    ...
    const IRHP_PERMIT_ANN_BILAT_MOROCCO_EMPTY_ENTRY = 'IRHP_PERMIT_MOROCCO_EMPTY_ENTRY';
    const IRHP_PERMIT_ANN_BILAT_MOROCCO_HORS_CONTINGENT = 'IRHP_PERMIT_MOROCCO_HORS_CONTINGENT';
    const IRHP_PERMIT_ANN_BILAT_MOROCCO_MULTI = 'IRHP_PERMIT_MOROCCO_MULTI';
    const IRHP_PERMIT_ANN_BILAT_MOROCCO_SINGLE = 'IRHP_PERMIT_MOROCCO_SINGLE';
    ...
    const IRHP_PERMIT_ANN_BILAT_RUSSIA = 'IRHP_PERMIT_ANN_BILAT_RUSSIA';
    ...
    const IRHP_PERMIT_ANN_BILAT_TUNISIA = 'IRHP_PERMIT_ANN_BILAT_TUNISIA';
    const IRHP_PERMIT_ANN_BILAT_TURKEY = 'IRHP_PERMIT_ANN_BILAT_TURKEY';
    const IRHP_PERMIT_ANN_BILAT_UKRAINE = 'IRHP_PERMIT_ANN_BILAT_UKRAINE';
