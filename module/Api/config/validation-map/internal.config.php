...
return [
    ...
    QueryHandler\Cpms\ReportStatus::class => IsInternalUser::class,
    ...
    QueryHandler\Organisation\BusinessDetails::class => IsInternalUser::class,
    QueryHandler\Organisation\CpidOrganisation::class => IsInternalUser::class,
    ...
    CommandHandler\Cpms\DownloadReport::class => IsInternalUser::class,
    ...
    CommandHandler\Disqualification\Update::class => IsInternalUser::class,
    ...
    CommandHandler\Document\PrintLetter::class => IsInternalUser::class,
    ...
    CommandHandler\Operator\UpdateUnlicensed::class => IsInternalUser::class,
    ...
    CommandHandler\Organisation\CpidOrganisationExport::class => IsInternalUser::class,
    CommandHandler\Organisation\TransferTo::class => IsInternalUser::class,
    ...
    CommandHandler\Tm\Merge::class => IsInternalUser::class,
    CommandHandler\Tm\Remove::class => IsInternalUser::class,
    CommandHandler\Tm\Unmerge::class => IsInternalUser::class,
    ...
    CommandHandler\Tm\UndoDisqualification::class => IsInternalUser::class,
];
