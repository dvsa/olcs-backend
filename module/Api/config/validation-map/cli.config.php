...
return [
    ...
    CommandHandler\Email\SendEcmtApggIssued::class => IsSystemUser::class,
    ...
    CommandHandler\Email\SendEcmtApsgSuccessful::class => IsSystemUser::class,
    CommandHandler\Email\SendEcmtApsgPartSuccessful::class => IsSystemUser::class,
    CommandHandler\Email\SendEcmtApsgPostScoring::class => IsSystemUser::class,
    ...
    CommandHandler\Email\SendEcmtShortTermApggIssued::class => IsSystemUser::class,
    CommandHandler\Email\SendEcmtShortTermApsgIssued::class => IsSystemUser::class,
