 ...
 */
class DocumentInfo implements CHRequest
{

    /**
     * xml template file
     */
    const DOCUMENT_INFO_FILE = "/xml/documentInfoRequest.xml";
    ...
    {
        // load xml file
        $body = simplexml_load_file(dirname(__FILE__) . self::DOCUMENT_INFO_FILE);
