 ...
 *    indexes={
 *        @ORM\Index(name="fk_opposer_contact_details1_idx", 
 *            columns={"contact_details_id"}),
 *        @ORM\Index(name="fk_opposer_ref_data1_idx", 
 *            columns={"opposer_type"}),
 *        @ORM\Index(name="fk_opposer_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_opposer_user2_idx", 
