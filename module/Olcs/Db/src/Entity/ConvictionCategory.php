 ...
 *    indexes={
 *        @ORM\Index(name="fk_conviction_category_conviction_category1_idx", 
 *            columns={"parent_id"}),
 *        @ORM\Index(name="fk_conviction_category_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_conviction_category_user2_idx", 
