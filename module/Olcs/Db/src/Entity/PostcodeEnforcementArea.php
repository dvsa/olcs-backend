 ...
 *    indexes={
 *        @ORM\Index(name="fk_PostcodeVehicleInspectorate_VehicleInspectorate1_idx", 
 *            columns={"enforcement_area_id"}),
 *        @ORM\Index(name="fk_postcode_enforcement_area_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_postcode_enforcement_area_user2_idx", 
 *            columns={"last_modified_by"})
 *    },
 *    uniqueConstraints={
 *        @ORM\UniqueConstraint(name="postcode_enforcement_area_unique", 
