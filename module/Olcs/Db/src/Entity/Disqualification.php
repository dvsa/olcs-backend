 ...
 *    indexes={
 *        @ORM\Index(name="fk_disqualification_person1_idx", 
 *            columns={"person_id"}),
 *        @ORM\Index(name="fk_disqualification_organisation1_idx", 
 *            columns={"organisation_id"}),
 *        @ORM\Index(name="fk_disqualification_transport_manager1_idx", 
 *            columns={"transport_manager_id"}),
 *        @ORM\Index(name="fk_disqualification_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_disqualification_user2_idx", 
