 ...
 *    indexes={
 *        @ORM\Index(name="fk_community_lic_withdrawal_reason_community_lic_withdrawal_idx", 
 *            columns={"community_lic_withdrawal_id"}),
 *        @ORM\Index(name="fk_community_lic_withdrawal_reason_community_lic_withdrawal_idx1", 
 *            columns={"reason_id"}),
 *        @ORM\Index(name="fk_community_lic_withdrawal_reason_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_community_lic_withdrawal_reason_user2_idx", 
