 ...
 *    indexes={
 *        @ORM\Index(name="fk_irfo_transit_country_irfo_psv_auth1_idx", 
 *            columns={"irfo_psv_auth_id"}),
 *        @ORM\Index(name="fk_irfo_transit_country_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_irfo_transit_country_user2_idx", 
