 ...
 *    indexes={
 *        @ORM\Index(name="fk_admin_area_traffic_area_traffic_area1_idx", 
 *            columns={"traffic_area_id"}),
 *        @ORM\Index(name="fk_admin_area_traffic_area_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_admin_area_traffic_area_user2_idx", 
