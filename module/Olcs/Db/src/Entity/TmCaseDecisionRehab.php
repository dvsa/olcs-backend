 ...
 *    indexes={
 *        @ORM\Index(name="fk_tm_case_decision_rehab_tm_case_decision1_idx", 
 *            columns={"tm_case_decision_id"}),
 *        @ORM\Index(name="fk_tm_case_decision_rehab_ref_data1_idx", 
 *            columns={"rehab_measure_id"}),
 *        @ORM\Index(name="fk_tm_case_decision_rehab_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_tm_case_decision_rehab_user2_idx", 
