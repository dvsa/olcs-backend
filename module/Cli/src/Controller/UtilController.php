...
class UtilController extends AbstractConsoleController
{
     ...
     * @return ConsoleModel
     */
    public function updateTogglesAction(): ConsoleModel
    {
        $params = [
        ...
        return $this->handleExitStatus(
            $this->handleCommand([UpdateFeatureToggle::create($params)])
        );
    }
    ...
    */
    ...
    {
        return $this->handleExitStatus(
            $this->handleQuery(new CliQuery\Util\FeatureToggles\FetchList())
        );
    }
