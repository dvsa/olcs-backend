...
/**
 * Tests PaymentFeeLink Controller
 *
...
use Olcs\Db\Controller\PaymentFeeLinkController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class PaymentFeeLinkControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new PaymentFeeLinkController();
    }
