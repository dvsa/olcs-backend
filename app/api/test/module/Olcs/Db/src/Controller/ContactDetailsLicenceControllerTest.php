...
/**
 * Tests ContactDetailsLicence Controller
 *
...
use Olcs\Db\Controller\ContactDetailsLicenceController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class ContactDetailsLicenceControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new ContactDetailsLicenceController();
    }
