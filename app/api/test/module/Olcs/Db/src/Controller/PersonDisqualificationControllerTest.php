...
/**
 * Tests PersonDisqualification Controller
 *
...
use Olcs\Db\Controller\PersonDisqualificationController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class PersonDisqualificationControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new PersonDisqualificationController();
    }
