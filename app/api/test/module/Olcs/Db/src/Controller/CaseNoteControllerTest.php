...
use Olcs\Db\Controller\CaseNoteController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class CaseNoteControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new CaseNoteController();
    }
