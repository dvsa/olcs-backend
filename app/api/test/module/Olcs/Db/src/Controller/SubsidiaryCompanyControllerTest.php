...
/**
 * Tests SubsidiaryCompany Controller
 *
...
use Olcs\Db\Controller\SubsidiaryCompanyController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class SubsidiaryCompanyControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new SubsidiaryCompanyController();
    }
