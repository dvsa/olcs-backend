...
/**
 * Tests OrganisationOwner Controller
 *
...
use Olcs\Db\Controller\OrganisationOwnerController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class OrganisationOwnerControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new OrganisationOwnerController();
    }
