...
use Olcs\Db\Controller\TradingNameController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class TradingNameControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new TradingNameController();
    }
