...
use Olcs\Db\Controller\ConvictionController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class ConvictionControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new ConvictionController();
    }
