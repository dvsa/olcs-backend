...
/**
 * Tests CardPaymentTokenUsage Controller
 *
...
use Olcs\Db\Controller\CardPaymentTokenUsageController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class CardPaymentTokenUsageControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new CardPaymentTokenUsageController();
    }
