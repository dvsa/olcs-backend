...
/**
 * Tests CaseDetailType Controller
 *
...
use Olcs\Db\Controller\CaseDetailTypeController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class CaseDetailTypeControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new CaseDetailTypeController();
    }
