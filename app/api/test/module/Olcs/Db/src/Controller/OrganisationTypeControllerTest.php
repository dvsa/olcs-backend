...
/**
 * Tests OrganisationType Controller
 *
...
use Olcs\Db\Controller\OrganisationTypeController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class OrganisationTypeControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new OrganisationTypeController();
    }
