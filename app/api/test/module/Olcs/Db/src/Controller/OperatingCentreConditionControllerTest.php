...
/**
 * Tests OperatingCentreCondition Controller
 *
...
use Olcs\Db\Controller\OperatingCentreConditionController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class OperatingCentreConditionControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new OperatingCentreConditionController();
    }
