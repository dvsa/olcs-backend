...
/**
 * Tests CaseCategoryLink Controller
 *
...
use Olcs\Db\Controller\CaseCategoryLinkController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class CaseCategoryLinkControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new CaseCategoryLinkController();
    }
