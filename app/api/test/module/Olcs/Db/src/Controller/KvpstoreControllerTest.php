...
use Olcs\Db\Controller\KvpstoreController;
 ...
 * @author Rob Caiger <rob@clocal.co.uk>
 */
class KvpstoreControllerTest extends PHPUnit_Framework_TestCase
{
    private $controller;
    ...
    protected function setUp()
    {
        ...
        $this->controller = new KvpstoreController();
    }
