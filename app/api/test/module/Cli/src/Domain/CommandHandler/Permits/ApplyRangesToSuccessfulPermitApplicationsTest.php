...
class ApplyRangesToSuccessfulPermitApplicationsTest extends CommandHandlerTestCase
{
    ...
    /**
     * Test that the correct range is assigned when there are no available restristed
     * or unrestricted ranges.
     *
     * Availability refers to there being no ranges that meet the criteria for assignment,
     * rather than no ranges existing.
     *
     */
    public function testAllRangesUnavailable()
    {
        $stockId = 8;
        ...
        $candidatePermits = [
            [
                'id' => 1,
                'countryCodes' => ['AX'] //Strictly speaking this should be a restricted country
            ],
        ];
