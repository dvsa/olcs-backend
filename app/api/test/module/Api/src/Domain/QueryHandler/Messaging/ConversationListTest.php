...
class ConversationListTest extends QueryHandlerTestCase
{
    ...
    public function testHandleQueryWithNewMessageOrdering()
    {
        ...
        $this->assertEquals(1, $result['result'][1]['id']);
    }
}
