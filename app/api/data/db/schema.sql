...
CREATE TABLE IF NOT EXISTS `application` (
  ...
  `tot_community_licences` INT NULL,
  `licence_type` VARCHAR(32) NOT NULL,
  `bankrupt` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `administration` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `disqualified` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `liquidation` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `receivership` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
...
CREATE TABLE IF NOT EXISTS `vehicle` (
  ...
  `vi_action` VARCHAR(1) NULL,
  `section_26` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `section_26_curtail` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `section_26_revoked` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `section_26_suspend` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '{CONFIG}{"type":"yesno"}{/CONFIG}',
  `deleted_date` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `application_completion` (
  `id` INT NOT NULL,
  `section_yb_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessStatus"}{/CONFIG}',
  `section_yb_bt_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessBusinessTypeStatus"}{/CONFIG}',
  `section_yb_bd_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessBusinessDetailsStatus"}{/CONFIG}',
  `section_yb_add_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessAddressesStatus"}{/CONFIG}',
  `section_yb_peo_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionYourBusinessPeopleStatus"}{/CONFIG}',
  `section_tol_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionTypeOfLicenceStatus"}{/CONFIG}',
  `section_tol_ol_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionTypeOfLicenceOperatorLocationStatus"}{/CONFIG}',
  `section_tol_ot_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionTypeOfLicenceOperatorTypeStatus"}{/CONFIG}',
  `section_tol_lt_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionTypeOfLicenceLicenceTypeStatus"}{/CONFIG}',
  `section_ocs_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionOperatingCentresStatus"}{/CONFIG}',
  `section_ocs_auth_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionOperatingCentresAuthorisationStatus"}{/CONFIG}',
  `section_ocs_fe_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionOperatingCentresFinancialEvidenceStatus"}{/CONFIG}',
  `section_tms_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionTransportManagersStatus"}{/CONFIG}',
  `section_veh_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionVehicleSafetyStatus"}{/CONFIG}',
  `section_veh_v_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionVehicleSafetyVehicleStatus"}{/CONFIG}',
  `section_veh_vpsv_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionVehicleSafetyVehiclePsvStatus"}{/CONFIG}',
  `section_veh_s_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionVehicleSafetySafetyStatus"}{/CONFIG}',
  `section_ph_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionPreviousHistoryStatus"}{/CONFIG}',
  `section_ph_fh_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionPreviousHistoryFinancialHistoryStatus"}{/CONFIG}',
  `section_ph_lh_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionPreviousHistoryLicenceHistoryStatus"}{/CONFIG}',
  `section_ph_cp_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionPreviousHistoryConvictionsPenaltiesStatus"}{/CONFIG}',
  `section_rd_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionReviewDeclarationsStatus"}{/CONFIG}',
  `section_pay_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionPaymentSubmissionStatus"}{/CONFIG}',
  `section_pay_pay_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionPaymentSubmissionPaymentStatus"}{/CONFIG}',
  `section_pay_summary_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionPaymentSubmissionSummaryStatus"}{/CONFIG}',
  `section_tp_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionTaxiPhvStatus"}{/CONFIG}',
  `section_tp_lic_status` TINYINT(1) NULL COMMENT '{CONFIG}{"property":"sectionTaxiPhvLicenceStatus"}{/CONFIG}',
