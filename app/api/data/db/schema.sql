...
CREATE TABLE `fee` (
  ...
  `payer` varchar(255) DEFAULT NULL COMMENT 'Payer name for the successful cash/cheque/postal order payment',
  `slip_no` varchar(45) DEFAULT NULL COMMENT 'Paying in slip number for the successful cash/cheque/postal order payment',
  `cheque_no` varchar(45) DEFAULT NULL COMMENT 'Cheque number',
  `po_no` varchar(45) DEFAULT NULL COMMENT 'Postal Order number',
  `created_by` int(11) DEFAULT NULL,
  `last_modified_by` int(11) DEFAULT NULL,
  `created_on` datetime DEFAULT NULL,
  `last_modified_on` datetime DEFAULT NULL,
