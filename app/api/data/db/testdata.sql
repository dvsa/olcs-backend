...
INSERT INTO `conviction` (`id`, `case_id`, `created_by`, `last_modified_by`, `category_text`, `birth_date`,
    ...
    (25,28,3,4,NULL,NULL,'2012-03-10','2012-06-15','FPN','3 points on licence','60',0,1,'John Smith Haulage Ltd.','defendant_type.operator',NULL,NULL,4,NOW(),NOW(),1,397),
    (26,NULL,0,4,NULL,NULL,'2012-04-10','2012-05-15','Leeds Magistrate court','3 points on licence','60',0,1,'','defendant_type.owner',NULL,NULL,4,NOW(),NOW(),1,399),
    (27,28,1,3,NULL,NULL,'2012-12-17','2013-03-02','FPN','3 points on licence','60',0,1,'','defendant_type.owner',NULL,NULL,4,NOW(),NOW(),1,399),
    (29,28,3,3,NULL,NULL,'2012-03-10','2012-06-15','Leeds Magistrate court','6 monthly investigation','2000',1,1,'John Smith Haulage Ltd.','defendant_type.operator',NULL,NULL,4,NOW(),NOW(),1,399);
...
INSERT INTO `category` (`id`, `created_by`, `last_modified_by`, `description`, `created_on`, `last_modified_on`,
    `version`) VALUES
...
INSERT INTO `licence` (
    ...
    (7,1,1,1,4,'Goods','OB1234567','lsts_new',1,'Standard National','2010-01-12','2010-01-12','2010-01-12','',4,12,NULL,
    NULL,NULL,NULL,NULL,NOW(),NOW(),1),
    (30,30,1,0,1,'Goods','OB1234568','lsts_new',1,'Standard International','2011-03-16','2011-03-16','2011-03-16','',3,
    9,NULL,NULL,NULL,NULL,NULL,NOW(),NOW(),1),
    (41,41,1,2,2,'Goods','OB1234577','lsts_new',0,'Standard International','2007-01-12','2007-01-12','2007-01-12','',1,
    21,NULL,NULL,NULL,NULL,NULL,NOW(),NOW(),1),
    (54,54,1,2,4,'Goods','OB1234578','lsts_new',0,'Restricted','2007-01-12','2007-01-12','2007-01-12','',0,4,NULL,NULL,
    NULL,NULL, NULL,NOW(),NOW(),1),
    (63,63,1,4,0,'PSV','PD1234589','lsts_new',0,'Standard National','2010-01-12','2010-01-12','2010-01-12','',1,7,NULL,
    NULL,NULL,NULL,NULL,NOW(),NOW(),1),
    (75,75,1,4,4,'PSV','PD2737289','lsts_new',0,'Standard National','2010-01-12','2010-01-12','2010-01-12','',0,4,NULL,
    NULL,NULL,NULL,NULL,NOW(),NOW(),1),
    (100,100,1,4,0,'PSV','PD1001001','lsts_new',0,'Standard National','2010-01-12','2010-01-12','2010-01-12','',0,4,
    NULL,NULL,NULL,NULL,NULL,NOW(),NOW(),2),
    (110,75,1,4,4,'PSV','PD2737289','lsts_new',0,'Restricted','2010-01-12','2010-01-12','2010-01-12','',0,4,NULL,NULL,
    NULL,NULL,NULL,NOW(),NOW(),1),
    (114,104,1,NULL,NULL,'PSV','OB1234567','lsts_new',1,'standard-national',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,
    NULL,NULL,NULL,'2014-04-30 12:07:14','2014-04-30 12:07:17',1),
    (115,105,1,NULL,NULL,'PSV','TS1234568','lsts_new',0,'Special Restricted',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,
...
INSERT INTO `reason` (`id`, `created_by`, `last_modified_by`, `goods_or_psv`, `is_decision`, `section_code`,
    `is_read_only`, `is_ni`, `created_on`, `last_modified_on`, `version`, `description`) VALUES
    ...
    (124,NULL,NULL,'GV',0,'03 - Section 26 (1)(a)',0,0,NULL,NULL,1,
    ...
    (126,NULL,NULL,'GV',0,'04.1 - Section 26 (1)(b)',0,0,NULL,NULL,1,
    '(1) Fail to notify of change in maintenance arrangements'),
    (127,NULL,NULL,'GV',0,'04.2 - Section 26 (1)(b)',0,0,NULL,NULL,1,'(2) Fail to notify of change in ownership'),
    (128,NULL,NULL,'GV',0,'04.3 - Section 26 (1)(b)',0,0,NULL,NULL,1,
    '(3) Fail to notify of notifiable convictions â€“ Sch 2 (restricted)'),
    (129,NULL,NULL,'GV',0,'04.4 - Section 26 (1)(b)',0,0,NULL,NULL,1,
    '(4) Fail to notify of events which affect good repute â€“ Sch 3 (standard)'),
...
INSERT INTO `user` (`id`, `created_by`, `last_modified_by`, `created_on`, `last_modified_on`, `version`, `deleted_date`,
    `name`) VALUES
