...
/**
 * Unfortunately due to the way the original DatabaseDriver was written, it was not easy to extend so I have had to
 * duplicate almost everything to override certain behaviour
 */
class DatabaseDriver implements MappingDriver
{
    ...
    public function loadMetadataForClass($className, ClassMetadata $metadata)
    {
        ...
        if (isset($this->mappingConfig[$className]['metadata']['skipManyToMany'])) {
            return;
        }
