 ...
 * @author Shaun Lizzio <shaun@lizzio.co.uk>
 */
abstract class AbstractCanCloseEntity extends AbstractValidator implements RepositoryManagerAwareInterface
{
