 ...
 * Update ReputeNotLost
 */
final class UpdateReputeNotLost extends AbstractCommandHandler implements TransactionedInterface
{
    ...
    public function handleCommand(CommandInterface $command)
    {
        ...
        if ($tmCaseDecision->getDecision()->getId() !== Entity::DECISION_REPUTE_NOT_LOST) {
