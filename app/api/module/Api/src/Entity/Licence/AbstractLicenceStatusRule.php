 ...
 * )
 */
abstract class AbstractLicenceStatusRule
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Dvsa\Olcs\Api\Entity\Licence\Licence", fetch="LAZY", inversedBy="licenceStatusRules")
     ...
     *
     * @param \Dvsa\Olcs\Api\Entity\System\RefData $licenceStatus
     * @return LicenceStatusRule
     */
