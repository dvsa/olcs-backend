 ...
 *    indexes={
 *        @ORM\Index(name="fk_si_penalty_serious_infringement1_idx", 
 *            columns={"serious_infringement_id"}),
 *        @ORM\Index(name="fk_si_penalty_si_penalty_type1_idx", 
 *            columns={"si_penalty_type_id"}),
 *        @ORM\Index(name="fk_si_penalty_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_si_penalty_user2_idx", 
