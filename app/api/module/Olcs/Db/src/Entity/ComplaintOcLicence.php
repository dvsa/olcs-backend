 ...
 *    indexes={
 *        @ORM\Index(name="fk_complaint_oc_licence_licence1_idx", 
 *            columns={"licence_id"}),
 *        @ORM\Index(name="fk_complaint_oc_licence_complaint1_idx", 
 *            columns={"complaint_id"}),
 *        @ORM\Index(name="fk_complaint_oc_licence_operating_centre1_idx", 
 *            columns={"operating_centre_id"}),
 *        @ORM\Index(name="fk_complaint_oc_licence_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_complaint_oc_licence_user2_idx", 
