 ...
 *    indexes={
 *        @ORM\Index(name="fk_prohoibition_defect_prohibition1_idx", 
 *            columns={"prohibition_id"}),
 *        @ORM\Index(name="fk_prohoibition_defect_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_prohoibition_defect_user2_idx", 
