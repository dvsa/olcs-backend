 ...
 * @ORM\Table(name="team",
 *    indexes={
 *        @ORM\Index(name="fk_team_traffic_area1_idx", 
 *            columns={"traffic_area_id"}),
 *        @ORM\Index(name="fk_team_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_team_user2_idx", 
 *            columns={"last_modified_by"}),
 *        @ORM\Index(name="fk_team_contact_details1_idx", 
 *            columns={"override_ta_contact_id"})
 *    }
 * )
 */
