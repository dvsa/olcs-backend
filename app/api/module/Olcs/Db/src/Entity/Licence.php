 ...
 *    indexes={
 *        @ORM\Index(name="fk_licence_vehicle_inspectorate1_idx", 
 *            columns={"enforcement_area_id"}),
 *        @ORM\Index(name="fk_licence_traffic_area1_idx", 
 *            columns={"traffic_area_id"}),
 *        @ORM\Index(name="fk_licence_organisation1_idx", 
 *            columns={"organisation_id"}),
 *        @ORM\Index(name="fk_licence_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_licence_user2_idx", 
 *            columns={"last_modified_by"}),
 *        @ORM\Index(name="fk_licence_ref_data1_idx", 
 *            columns={"goods_or_psv"}),
 *        @ORM\Index(name="fk_licence_ref_data2_idx", 
 *            columns={"licence_type"}),
 *        @ORM\Index(name="fk_licence_ref_data3_idx", 
 *            columns={"status"}),
 *        @ORM\Index(name="fk_licence_ref_data4_idx", 
 *            columns={"tachograph_ins"})
 *    },
 *    uniqueConstraints={
 *        @ORM\UniqueConstraint(name="licence_lic_no_idx", 
 *            columns={"lic_no"})
 *    }
 * )
 */
