 ...
 *    indexes={
 *        @ORM\Index(name="fk_tm_case_decision_unfitness_tm_case_decision1_idx", 
 *            columns={"tm_case_decision_id"}),
 *        @ORM\Index(name="fk_tm_case_decision_unfitness_ref_data1_idx", 
 *            columns={"unfitness_reason_id"}),
 *        @ORM\Index(name="fk_tm_case_decision_unfitness_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_tm_case_decision_unfitness_user2_idx", 
