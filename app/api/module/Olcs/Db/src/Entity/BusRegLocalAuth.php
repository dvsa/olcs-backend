 ...
 *    indexes={
 *        @ORM\Index(name="fk_bus_reg_local_auth_local_authority1_idx", 
 *            columns={"local_authority_id"}),
 *        @ORM\Index(name="fk_bus_reg_local_auth_user1_idx", 
 *            columns={"created_by"}),
 *        @ORM\Index(name="fk_bus_reg_local_auth_user2_idx", 
 *            columns={"last_modified_by"}),
 *        @ORM\Index(name="fk_bus_reg_local_auth_bus_reg1", 
 *            columns={"bus_reg_id"})
 *    },
 *    uniqueConstraints={
 *        @ORM\UniqueConstraint(name="bus_reg_la_unique", 
 *            columns={"local_authority_id","bus_reg_id"})
 *    }
 * )
 */
