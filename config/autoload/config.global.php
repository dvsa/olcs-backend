...
return [
    ...
    'email' => [
        ...
        'send_all_mail_to' => $isProduction ? '%olcs_send_all_mail_to%' : null,
...
'awsOptions'=>[
    ...
    'output_s3_bucket' => '%tranxchange_aws_s3_output_bucket%',
        // The cross account role that VOL will assume to access the output bucket and output SQS queue.
        'txc_consumer_role_arn' => '%tranxchange_aws_consumer_role%',
    ...
    'nysiis' => [
    'soap' => [
        'wsdl' => __DIR__ . '/../../module/Api/data/nysiis/wsdl/nysiisUAT.svc.wsdl',
        'options' => [
            'soap_version' => 1,
            'encoding' => 'UTF-8',
            'local_cert' =>'/etc/ssl/certs/atos-ca1.pem'
        ]
    ],
    'rest' => [
